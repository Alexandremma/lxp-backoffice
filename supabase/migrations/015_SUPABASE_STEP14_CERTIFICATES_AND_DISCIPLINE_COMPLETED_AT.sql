-- STEP 14 - completed_at + certificados (templates, assinaturas, emissoes)
-- Idempotente. MCP (ja aplicado neste projeto): lxp_step14a_discipline_completed_at, lxp_step14b_certificate_core_tables
-- Depende de: lxp_profiles, lxp_course_disciplines, is_admin() / is_student() (Step 4).

-- ---------- 14a) Disciplina: completed_at + trigger ----------
...
-- ---------- 4) Emissões (código único de validação) ----------
...
-- Aluno não altera emissão depois de criada (sem policy UPDATE para student)
